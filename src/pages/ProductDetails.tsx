        ...
        <div className="container max-w-6xl mx-auto px-6 py-12">
                    ...
                    <div className="mt-6 flex gap-3 justify-center">
                      {images.map((img, i) => (
                        <button
                          ...
                          className={`rounded-xl overflow-hidden transition-all duration-300 ${i === index ? "ring-2 ring-primary ring-offset-2 scale-110" : "opacity-60 hover:opacity-100"
                            }`}
          ...
          >
            <div className="max-w-4xl mx-auto">
              <h2 className="font-display text-3xl font-medium mb-8" style={{color: '#442f2a'}}>Customer Reviews</h2>
